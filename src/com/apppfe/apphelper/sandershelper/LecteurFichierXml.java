...
public class LecteurFichierXml {
    ...
    private int nomblreTotalTweetARecuperer;
    ...
    public LecteurFichierXml() {
        ...
        this.nomblreTotalTweetARecuperer = 0;
        this.listeDeTweet = new ArrayList<Tweet>();
        this.saxBuilder = new SAXBuilder();
        this.xmlFile = new File(LecteurFichierXml.class.getResource("/com/apppfe/apphelper/data/tweets_combines.xml").getPath());
    ...
    /**
     * Cette méthode va lire tout les éléments du fichier xml et les mettre
     * dans la listeDeTweets
     */
    public void lireFichierDeTweet() {

        System.out.println("la racine du fichier xml est : " + racine.getName());   //test de succès de la lecture
        ...
        for (Element elementTweet : listElementTweet) { //ici je suis dans l'elemnt <tweet> de mon fichier xml
            ...
            //maintant madabik tsegmi les type ta3 hadoma pour faciliter la création de tweet après
            ...
            nomblreTotalTweetARecuperer ++;// doka essaye de creere un nouveau tweet ici puis l'ajouter a la liste'

            //création d'un vouveau tweet + ajout dans la liste

            Tweet tweet = new Tweet(idTweet, user, tweettext, location, date,favoris, language, placename, retweets, 0.0);
    ...
    public int getNomblreTotalTweetARecuperer() {
        return nomblreTotalTweetARecuperer;
    }

    public void setNomblreTotalTweetARecuperer(int nomblreTotalTweetARecuperer) {
        this.nomblreTotalTweetARecuperer = nomblreTotalTweetARecuperer;
    }
